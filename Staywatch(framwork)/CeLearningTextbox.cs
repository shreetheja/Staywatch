...
namespace Staywatch_framwork_
{
    public class CeLearningTextbox : Control
    {
        ...
        {
            this.shape = new RoundTextBox((float)base.Width, (float)base.Height, (float)this.radius, 0f, 0f).Path;
            this.innerRect = new RoundTextBox(base.Width - 0.5f, base.Height - 0.5f, (float)this.radius, 0.5f, 0.5f).Path;
